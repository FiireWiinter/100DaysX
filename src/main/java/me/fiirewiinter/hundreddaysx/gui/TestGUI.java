...
public class TestGUI {
    ...
    public void initialize() {
        ...
        this.inv = Bukkit.createInventory(null, this.inv_rows);
    }

    public Inventory GUI(Player p) {
        Inventory toReturn = Bukkit.createInventory(null, this.inv_rows, this.inventory_name);
        Utils.createItem(this.inv, "rail", 1, 13, "&cTest Item", "&7Lore Line 1", "&1Lore Line 2", "&4Lore Line 3");
